...
import { TaxCode } from "../../components/form/TaxCode"
import { TaxID } from "../../components/form/TextID"
...
export function Register() {
    ...
    useEffect(() => {
        ...
        var feedback = document.getElementsByClassName('input-feedback')[0]
    ...
    return (
        <>
            {loading ? (
                ...
                <main className="relative w-full h-auto min-h-screen ">
                    <article className="max-w-5xl h-full mx-auto py-8 px-10 md:px-12 bg-white text-body flex flex-col gap-8">
                        ...
                        <section className="flex-1 flex flex-col items-center">
                            <div className="text-center py-7">
                                <h1 className="uppercase font-extrabold text-3xl text-center text-body font-titillium">Finalize o seu cadastro para <br className="hidden lg:block" />participar das campanhas</h1>
